% clearvars -except behaviorDataAll data trials
close all
...
% matlabpool = parpool(4);
%%
%%%%%%%%%%%%%%%%%% apply clusterDv %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

kdedens = [];
densityType = 'localp';%type of density estimation: local or localp to normalize dimentions
...
nsamps = 10;%should be large enough - 10 is often enough
multirep = 0;%times to repeat ref distribution: if zero it will not do any reference distribution
makeplot = 1;
numbPointsToShow = 10;%so it does not show too many points
clusterThreshold = 0.00001;%sometimes is has really small numbers
...
makePlot2 = 1;
maxNumbOfClusterCenters= 10;%so it does not take too much time
